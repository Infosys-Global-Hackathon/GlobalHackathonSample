# Contributing to GlobalHackathonSample

Thank you for your interest in contributing to the GlobalHackathonSample project! This repository serves as a template for teams participating in hackathons focused on sustainable development and social impact.

When contributing a major change to this repository, please first discuss the change you wish to make via an [issue](https://github.com/Infosys-Global-Hackathon/GlobalHackathonSample/issues) or via [GitHub Discussions](https://github.com/Infosys-Global-Hackathon/GlobalHackathonSample/discussions). Minor issues can simply be addressed by sending a pull request.
...
reported by contacting the project team via [GitHub Issues](https://github.com/Infosys-Global-Hackathon/GlobalHackathonSample/issues) or [GitHub Discussions](https://github.com/Infosys-Global-Hackathon/GlobalHackathonSample/discussions). 
